...
for filename in all_files:
    ...
    try:
        for params, scores in utils.participant_train_test_xgboost(participant=participant, train_dir=settings.not_filtered_dataset_dir, m=settings.m, model_dir=settings.not_filtered_model_dir):
