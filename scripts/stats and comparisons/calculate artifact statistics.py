...
sensing_window_sizes = {
    ...
    'azizsambo58@gmail.com': 3600000,
    'jskim@nsl.inha.ac.kr': 3600000,
    'jumabek4044@gmail.com': 3600000,
    'laurentkalpers3@gmail.com': 3600000,
    'mr.khikmatillo@gmail.com': 3600000,
    'nazarov7mu@gmail.com': 3600000,
    'nnarziev@gmail.com': 3600000,
    'nslabinha@gmail.com': 3600000,
...
with open('artifact_stats.csv', 'w+') as w:
    w.write('participant,ppg artifacts,ppg & acc artifacts,acc artifacts,clean,amount\n')
    for email in emails:
        print('counting artifacts of "', email, "'s IBI readings")
            ...
            while timestamp > till_timestamp:
                ...
                if selected_rr_intervals is not None and selected_acc_values is not None and selected_ppg_values is not None:
                    try:
                        ...
                        is_ppg_artifact = get_ppg_stdev(ppg_values=selected_ppg_values) >= ppg_threshold
                        is_acc_artifact = is_acc_window_active(acc_values=selected_acc_values, from_ts=timestamp, threshold=acc_threshold)
                        ...
                        pass
        w.write(f'{email},{ppg_artifacts_count},{ppg_acc_artifacts_count},{acc_artifacts_count},{clean_count}\n')
